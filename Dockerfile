...
RUN apt-get update
RUN apt-get install -y libav-tools libavcodec-extra-54 python python-pip python-dev redis-server
RUN pip install --upgrade youtube_dl celery[librabbitmq,redis] boto
